...
//     { id: 1, name: 'Olivia Martinez', age: 32, state: 'Barisal', image: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=400&h=400&fit=crop' },
//     { id: 2, name: 'Jane Smith', age: 31, state: 'Khulna', image: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=400&h=400&fit=crop' },
//     { id: 3, name: 'Emily Davis', age: 29, state: 'Rajshahi', image: 'https://images.unsplash.com/photo-1524504388940-b1c1722653e1?w=400&h=400&fit=crop' },
//     { id: 4, name: 'Sophia Brown', age: 35, state: 'Sylhet', image: 'https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?w=400&h=400&fit=crop' },
//   ];
    ...
    try {
      ...
      if (res.data.user?.country) {
        const relatedRes = await axios.get(
          `http://localhost:5000/api/register/related/${res.data.user.country}/${id}`
        );
